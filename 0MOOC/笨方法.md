...
Argv = argument variable, 及所谓'参数变量', 这个变量保存着你运行Python脚本时传递给Python脚本的参数.
...
本习题的示范代码如上, 在命令行中运行时,注意!输入python ex13.py后面要追加三个命令行参数( python ex13.py first 2nd 3rd )才能实现应该看到的结果.
